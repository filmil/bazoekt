...
def bazoekt_go_dependencies():
    ...
    go_repository(
        name = "com_github_filmil_zoekt",
        importpath = "github.com/filmil/zoekt",
        sum = "h1:Nll5nF55qcy7CXkWdz5Djy+71R/1xPbvoARjteV+JnE=",
        version = "v0.0.0-20250316102758-dcadb48bf1e3",
    )
    go_repository(
    ...
    go_repository(
        name = "com_tedunangst_humungus_r_gerc",
        importpath = "humungus.tedunangst.com/r/gerc",
        sum = "h1:eW5yTbRLFFWSu/RpTdkLxaVPlNlFUzxc02VQsftzg64=",
        version = "v0.1.2",
    )
    go_repository(
